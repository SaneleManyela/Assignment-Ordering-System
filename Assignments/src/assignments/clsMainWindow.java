...
public class clsMainWindow extends JFrame{
    ...
    private JPanel mCreateCenter() {
        ...
        mAddComponent(jpPanel, mCreateLabel("Systems Development", 180, 20, Color.BLACK, 
                Color.WHITE), 4, 4, 2, 1, 0, 0, GridBagConstraints.NONE, 
                GridBagConstraints.LINE_START, new Insets(20, 20, 20, 20));
        mAddComponent(jpPanel, mCreateButton(180, 101, new ImageIcon(this.getClass().getResource("Net.jpeg")), this::mOpenNetAssignments),
                8, 0, 3, 3, 0, 0, GridBagConstraints.NONE, GridBagConstraints.LINE_START, 
                new Insets(20, 20, 20, 20));
        mAddComponent(jpPanel, mCreateLabel("Networking", 180, 20, Color.BLACK, 
                Color.WHITE), 8, 4, 2, 1, 0, 0, GridBagConstraints.NONE, 
                GridBagConstraints.LINE_START, new Insets(20, 20, 20, 20));
        return jpPanel;
    }
    ...
    private void mOpenSyDevAssignments(ActionEvent e) {
        clsSyDevAssignments clsSyDev = new clsSyDevAssignments();
    }
